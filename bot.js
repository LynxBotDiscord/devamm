...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('Lynx Bot | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('Yardımcı BOT | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**Lynx Bot| 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
...
if (message.content.toLowerCase() ===  '!destek-sunucu'){
   message.reply('https://discord.gg/rB6DbS8');
    }
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa') {
    msg.reply('Aleyküm selam, Hoşgeldin Kankam.');
  }
});
client.on('message', msg => {
